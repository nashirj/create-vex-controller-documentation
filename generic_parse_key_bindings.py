...
ROBOT_NAME = 'SMC 2019-2020 15in robot'
ROBOT_NAME_SHORT = 'SMC_15'
# change IMG_LOCATION if you prefer to use a different image or one hosted at a different link
IMG_LOCATION = f'https://raw.githubusercontent.com/smcrobotics/competition_bot_15_inch/master/docs/controller.png'
